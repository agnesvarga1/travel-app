...
<template>
  <header
    class="md:h-14 h-11 text-dark bg-light fixed top-0 left-0 p-3 w-full bg-white"
  >
    <div class="sm:w-full md:w-10/12 md:mx-auto">
      <router-link :to="{ name: 'home' }">
        <div class="logo flex items-baseline">
          ...
          <h1 class="font-heading md:text-3xl">ravel-App</h1>
        </div>
      </router-link>
    </div>
  </header>
